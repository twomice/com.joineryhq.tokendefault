 ...
 */
class CRM_Tokendefault_Upgrader_Base {

  /**
   * @var CRM_Tokendefault_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_Tokendefault_Upgrader(
        'com.joineryhq.tokendefault',
        realpath(__DIR__ . '/../../../')
      );
    }
   ...
   *
   * ```
   * CRM_Tokendefault_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Tokendefault_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
